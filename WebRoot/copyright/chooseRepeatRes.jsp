...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
	   		...
	   		var _sortOrder = 'desc';
			var _colums = [{field:'commonMetaDatas.unit',title:'内容单元',width:fillsize(0.2),sortable:true},
							{field:'commonMetaDatas.title',title:'资源标题',width:fillsize(0.17),sortable:true},
							{field:'commonMetaDatas.creator',title:'制作者',width:fillsize(0.07),sortable:true},
							{field:'commonMetaDatas.keywords',title:'关键字',width:fillsize(0.1),sortable:true},
							{field:'commonMetaDatas.modified_time',title:'更新时间',width:fillsize(0.18),sortable:true},
...
<form id="queryForm" action="" target="work_main" method="post">
	<div class="row">
        ...
        <div class="col-xs-6" align="right" style="padding-right: 10px;">
        	<input type="button" value="搜索" class="btn btn-primary red" onclick="query()"/>  
