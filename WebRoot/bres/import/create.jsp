	...
	<script type="text/javascript">
		...
		$(function() {
		    ...
		    $('#fileData').uploadify({
		        ...
		        'uploader' : 'saveRes.action?module=${param.module};jsessionid=<%=session.getId()%>',
		        'debug' : false,
		        //是否自动上传
		        'auto':false,
		        'buttonText':'上传文件',
		...
		function downTemplete(){
			...
			window.location.href = "${path}/bres/downloadTemplete/"+module+".action";
		}
	</script>
</head>
<body>
	...
	<form action="#" id="coreData" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				...
				<label class="radio-inline">
					<input type="radio" name="repeatType" value="1"/> 新建
				</label>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-9">
				<label class="checkbox-inline">
					<input type="checkbox" name="repeatRelevanceType" value="1" /> 自动关联
				</label>
			</div>
		</div>
		<div class="form-group">
