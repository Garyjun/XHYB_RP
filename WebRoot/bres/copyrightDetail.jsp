	                                ...
	                                <div class="col-md-6">
	                                        <div class="form-group">
	                                            ...
	                                            <app:select name="copyRightMetaData.crtType" indexTag="crtType" id="crtType"  selectedVal="${crtType}" headName="请选择"  headValue=""  />
	                                            	<input type="text" id="crtTypeDetail" class="form-control"/>
	                                            </div> 
	                                        </div>
	                                </div>
	                                <div class="col-md-6 filed" >
	                                    <div class="form-group">
	                                        ...
	                                        <app:select name="copyRightMetaData.authArea" indexTag="authArea" id="authArea"  selectedVal="" headName="请选择"  headValue=""  />
	                                            	<input type="text" id="authAreaDetail" class="form-control"/>
	                                            </div> 
	                                    </div>
	                                </div>
	                                <div class="col-md-6 filed" >
	                                    <div class="form-group">
	                                        ...
	                                        <div class="col-md-8">
	                                        	...
	                                        	<input type="text" id="authChannelDetail" class="form-control"/>
	                                        </div>
	                                    </div>
	                                </div>
	                                <div class="col-md-6 filed" >
	                                    <div class="form-group">
	                                        ...
	                                        <div class="col-md-8">
	                                            ...
	                                            <input type="text" id="authLanguageDetail" class="form-control"/>
	                                        </div>
	                                    </div>
	                                </div>
	                                <div class="col-md-6 filed" >
	                                    <div class="form-group">
	                                        ...
	                                        <div class="col-md-8">
	                                            ...
	                                            <input type="text" id="permitRightDetail" class="form-control"/>
	                                        </div>
	                                    </div>
	                                </div>
	                                <div class="col-md-6 filed" >
	                                    <div class="form-group">
	                                        ...
	                                        <div class="col-md-8">
	                                            ...
	                                            <input type="text" id="collaPatternDetail" class="form-control"/>
	                                        </div>
	                                    </div>
	                                </div>
	                            </div>
	                            <div class="row">
	                                ...
	                                <div class="col-md-6">
	                                    <div class="form-group">
	                                        ...
	                                        <div class="col-md-8">
 	                                        <input type="text" id="authStartDate" name="authStartDate"  class="form-control" style="width: 47.3%;display:inline"/>&nbsp;-&nbsp;
	                                        <input type="text" id="authEndDate" name="authEndDate"  class="form-control" style="width: 47.3%;display:inline"/> 
	                                        </div>
	                                    </div>
	                                </div>
	                            </div>
