...
<head>
	...
	<style type="text/css">
		.no_border{border:none;background-color: white !important;cursor: default !important;}
		 .col-md-6 {width: 50%;display:inline-block;float:left;}
	...
	<script type="text/javascript">
		...
		$operate = function(value,rec){
			...
			opt += "<a class=\"btn hover-blue\" href=\"javascript:downRes("+rec.objectId+")\" ><i class=\"fa fa-trash-o\"></i> 下载</a>";
    ...
    <div class="by-tab">
            ...
            <div class="portlet-body">
                <div class="container-fluid">
                    <c:if test="${not empty objectId}">
                     <div class="row">
                            <div class="form-group">
                            	<div id="data_div" class="data_div height_remain" style="width: 725px;"></div>
                            </div>
                     </div>
                     </c:if>
                </div>
        ...
        <c:if test="${not empty execuId}">
			<div class="portlet portlet-border">
			  ...
			  <div class="panel-body" id="999" style="width:740px;">
