...
// 			nodeNames = parentName+","+nodeNames;
...
// 				}
				...
				parentWin.$('#category').val(nodeNames);
				var names = "";
				if(nodeNames.length>60){
					names = nodeNames.substring(0,60)+"...";
					parentWin.$('#buttonFlag').val(names);
				}else{
					parentWin.$('#buttonFlag').val(nodeNames);
				}
				parentWin.query();
				$.closeFromInner();
			}
