 ...
 * modi by tangzk 2566行 "panel" => "by-panel"
 * 替换 panel-body => by-panel-body
 * 替换 panel-title => by-panel-title
 * 
 * modi by zuohl 2014年4月29日 9102行，支持field点属性
 * modi by zhangpeng 2014年11月19日 9302行 控制是否显示列出所有的头字段即点击头字段弹出的下拉箭头
 */
(function ($) {
...
(function ($) {
    ...
    function _1dd(_1de, _1df) {
        ...
        var _1e2 = _1e0.children("div.by-panel-body");
        if (_1df) {
    ...
    function _1e7(_1e8) {
        $(_1e8).addClass("by-panel-body");
        var _1e9 = $("<div class=\"by-panel\"></div>").insertBefore(_1e8);
    ...
    function _1ea(_1eb) {
        ...
        if (opts.title && !opts.noheader) {
            var _1ed = $("<div class=\"panel-header\"><div class=\"by-panel-title\">" + opts.title + "</div></div>").prependTo(_1ec);
            if (opts.iconCls) {
                _1ed.find(".by-panel-title").addClass("panel-with-icon");
            ...
            if (opts.collapsible) {
                $("<a class=\"panel-tool-collapse\" href=\"javascript:void(0)\"><i class=\"glyphicon glyphicon-minus\"></a>").appendTo(tool).bind("click", function () {
            ...
            if (opts.closable) {
                $("<a class=\"panel-tool-close\" href=\"javascript:void(0)\"><i class=\"glyphicon glyphicon-remove\"></a>").appendTo(tool).bind("click", function () {
                    _1ee(_1eb);
                    return false;
                });
            }
            _1ec.children("div.by-panel-body").removeClass("by-panel-body-noheader");
        } else {
            _1ec.children("div.by-panel-body").addClass("by-panel-body-noheader");
        }
    };
    function _1ef(_1f0) {
    ...
    function _1fd(_205, _206) {
        ...
        var body = _207.children("div.by-panel-body");
        ...
        tool.html("<i class=\"glyphicon glyphicon-plus\"></a>");
        if (_206 == true) {
    ...
    function _208(_209, _20a) {
        ...
        var body = _20b.children("div.by-panel-body");
        ...
        tool.html("<i class=\"glyphicon glyphicon-minus\"></a>");
        if (_20a == true) {
    ...
    function _214(_215) {
        ...
        if (opts.border) {
            ...
            body.removeClass("by-panel-body-noborder");
        } else {
            _217.addClass("panel-header-noborder");
            body.addClass("by-panel-body-noborder");
        }
    ...
    function _218(_219, _21a) {
        ...
        $(_219).panel("header").find("div.by-panel-title").html(_21a);
    };
    var TO = false;
    var _21b = true;
    ...
    $.fn.panel.methods = {options: function (jq) {
        ...
        return $.data(jq[0], "panel").panel.find(">div.by-panel-body");
...
(function ($) {
    ...
    function _246(_247) {
        ...
        _248.window.draggable({handle: ">div.panel-header>div.by-panel-title", disabled: _248.options.draggable == false, onStartDrag: function (e) {
            if (_248.mask) {
...
(function ($) {
    ...
    function _4ea(_4eb) {
        ...
        //zuohl datagrid-view 宽度计算，考虑到边框，改变原来设置width 后来设置outerWidth
        view.outerWidth(_4ec);
    ...
    var _688 = {render: function (_689, _68a, _68b) {
        ...
        for (var i = 0; i < _699.length; i++) {
            ...
            if (col) {
                // 源码 var _69f = _69c[_69e]; 修改后如下，zuohl
        ...
        /** Tangzk. **/
        var buildFiledInput = function() {
            var inputHtml = '<form class="form-inline" role="form">';
            $.each(opts.columns[0], function(k, v) {
                inputHtml += '<div class="checkbox"><label><input type="checkbox" checked="checked" onclick="byCkField(this, \'' + _6c1.id + '\', \'' + v.field + '\')"> ' + v.title + '</label></div>';
            });
            inputHtml += '</form>';
            return inputHtml;
        }
        window.byCkField = function(me, id, field) {
            if($(me).is(":checked")) {
        ...
        if (opts.showHeader) {
            var _zk0 = $(_6c1).datagrid("getPanel").find(".datagrid-view2");
            var _zk1 = _zk0.children(".datagrid-header");
            if(_zk1 && _zk1.length > 0) {
                var _zk2 = _zk0.children(".datagrid-body");
                var _zk3 = _zk0.children(".datagrid-col-sel-btn");
                if(_zk3 && _zk3.length === 0) {
                    _zk0.append("<div class=\"datagrid-col-sel-btn\"><i class=\"fa fa-angle-down\"></i></div><div class=\"datagrid-body-layer\"></div>");
                    _zk3 = _zk0.children(".datagrid-col-sel-btn");
                    _zk4 = _zk0.children(".datagrid-body-layer");
                    setTimeout(function(){
                        var _ht = _zk2.height();
                        var th = null;
                        _zk4.css({height: _ht + "px", "top": -_ht + "px"}).html(buildFiledInput());
                        if(opts.showMoreMenu){
                        	_zk1.on("mouseenter", function (evt) {
                                clearTimeout(th);
                                if (_zk3.is(":animated")) {
                                    _zk3.stop(true, false)
                                }
                                _zk3.show().animate({top: 36}, 333);
                            }).on("mouseleave", function (evt) {
                                th = setTimeout(function () {
                                    if (_zk3.is(":animated")) {
                                        _zk3.stop(true, true)
                                    }
                                    _zk3.animate({top: 0}, 333, "linear", function () {
                                        _zk3.hide()
                                    });
                                }, 500);
                            });
                        }
                        _zk3.on("mouseenter", function () {
                            clearTimeout(th);
                            if (_zk3.is(":animated")) {
                                _zk3.stop(true, false)
                            }
                            ...
                            if (_zk4.is(":hidden")) {
                                _zk3.off("mouseleave");
                                if (_zk4.is(":animated")) {
                                    _zk4.stop(true, false)
                                }
                                _zk4.show().animate({top: 36}, 333, "linear", function () {
                                    _zk3.html("<i class=\"fa fa-angle-up\"></i>")
                                });
                            } else {
                                _zk3.on("mouseleave", function () {
                                    th = setTimeout(function () {
                                        if (_zk3.is(":animated")) {
                                            _zk3.stop(true, true)
                                        }
                                ...
                                _zk4.animate({top: -_ht}, 333, "linear", function () {
                                    _zk4.hide();
                                    _zk3.html("<i class=\"fa fa-angle-down\"></i>")
                                });
                            }
                        });
                    }, 0);
...
(function ($) {
    ...
    var _6fb = $.extend({}, $.fn.datagrid.defaults.view, {render: function (_6fc, _6fd, _6fe) {
        ...
        if ((_704 && (opts.rownumbers || opts.frozenColumns.length)) || (!_704 && !(opts.rownumbers || opts.frozenColumns.length))) {
            _707.push("<td style=\"border:0;text-align:center;width:36px\"><span class=\"datagrid-row-expander datagrid-row-collapse\" style=\"display:inline-block;width:16px;height:16px;cursor:pointer\">&nbsp;</span></td>");
        }
        ...
        function _714() {
            if (!$("#datagrid-group-style").length) {
                $("head").append("<style id=\"datagrid-group-style\">" + ".datagrid-group{height:36px;overflow:hidden;font-weight:bold;border-bottom:1px solid #ccc;}" + "</style>");
            }
        };
    }});
