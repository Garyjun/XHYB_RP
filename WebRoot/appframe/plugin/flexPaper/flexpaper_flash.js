...
function hiddenLeftBar(){
	document.getElementById('canLeft').style.display = 'none';
	document.getElementById('canMiddle').style.display = 'none';
}

/*2013年01月23日 显示 左侧内容*/
function showLeftBar(){
	document.getElementById('canLeft').style.display = 'block';
	document.getElementById('canMiddle').style.display = 'block';
}
/**
*
