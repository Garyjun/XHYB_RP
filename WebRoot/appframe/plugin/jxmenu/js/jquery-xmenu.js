...
(function($) {
	...
	$.fn.xMenu = function(options) {
		return $(this).each(function() {
			...
			//最大数
			var hiddenMaxNumber = $("#"+owl.hiddenID+"MaxNumber");
			...
			$okbtn.click(function(){
				...
				//判断选择最大值与当前所选值大小
				if(hiddenMaxNumber.val()!=undefined && hiddenMaxNumber.val()!="" && hiddenMaxNumber.val()!=null){
					var hiddenMaxNumberVal = hiddenMaxNumber.val();
					var ids = id.split(",");
					var len = ids.length;
					if(len > hiddenMaxNumberVal){
						$.alert("最大只能选择["+hiddenMaxNumberVal+"]项");
						return;
					}
				}
