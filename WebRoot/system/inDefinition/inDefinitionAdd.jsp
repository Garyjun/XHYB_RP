...
<body>
	<div id="fakeFrame" class="container-fluid by-frame-wrap" style="height: 100%;">
		<div class="form-wrap">
		<form:form action="${path}/system/inDefinition/addAction.action" id="form" target="_parent" modelAttribute="frmDefinition" method="post" class="form-horizontal" role="form">
