...
<head>
	...
	function getTreeValue(){
		...
		$.ajax({
			type:"post",
			async:false,
			url:"${path}/system/metaData/detail.action",
...
<body>
	<div id="fakeFrame" class="container-fluid by-frame-wrap" style="height: 100%;">
		<div class="form-wrap">
		<form:form action="${path}/system/metaData/addAction.action" id="form" modelAttribute="frmSourceGroup" method="post" class="form-horizontal" role="form">
			...
			<div class="form-group">
				...
				<div class="col-xs-5">
					<form:radiobutton path="storeType" value="1" checked="true"/>单对象SCO
			...
			<div class="form-group">
				<div class="col-xs-offset-4" style="margin-left:500px">
					<div class="form-wrap">
