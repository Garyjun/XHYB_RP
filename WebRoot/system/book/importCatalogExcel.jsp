...
<head>
	...
	$(function() {
	    ...
	    $('#fileData').uploadify({
	        ...
	        'uploader' : 'importCatalogExcel.action',
	        'debug' : false,
	        //是否自动上传
	        'auto':false,
	        'buttonText':'上传文件',
	        ...
	        'onUploadStart': function (file) { 
	        	$("#fileData").uploadify("settings", "formData",{fromId:$("#fromId").val(),pid:$("#pid").val()});  
        	},
...
<body>
	<div class="form-wrap">
	    ...
	    <input type="hidden" id="fromId" value="<%=request.getParameter("fromId")%>"/>
