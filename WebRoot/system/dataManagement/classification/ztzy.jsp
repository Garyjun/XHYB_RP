...
<head>
	...
	function importExcel(){
		$.openWindow("${path}/system/dataManagement/classification/importClassicExcel.jsp?moudleName=ztzy",'导入分类体系',450,200);
	}
    ...
    $(document).ready(function(){
        var t = $("#tree");
		$.get("listClassification.action?moudleName=ZT",
			function(data) {
				var books = eval("("+data+")");
...
<body>
	...
	<input id="moudleName" type="hidden" value="ZT"/>
</body>
</html>