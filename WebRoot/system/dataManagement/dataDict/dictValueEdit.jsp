	...
	<div id="fakeFrame" class="container-fluid by-frame-wrap" style="height: 100%;">
		...
		<form:form action="updDictValue.action" id="form" modelAttribute="frmDictValue" method="post" class="form-horizontal" role="form">
			<div class="form-group">
				...
				<div class="col-xs-5">
					<form:input path="name"  class="form-control validate[required, maxSize[200]] text-input"/>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-xs-5">
					<form:input path="indexTag" class="form-control validate[required, maxSize[200]]"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-xs-5">
					<form:textarea path="description" rows="5" class="form-control validate[maxSize[256]]"/>
				</div>
			</div>
			<div class="form-group">
