...
<body  class="yui-skin-sam" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="overflow: auto;" scroll="auto" >
	<table  width="100%" border="0" cellspacing="1" cellpadding="3"  id="tjjgDiv" >
				<tr>
					...
					<tr>	<td bgcolor="#ffffff" height="22px">
					数据不存在！
					</td>
					</tr>
					</c:when>
					...
					<c:forEach  items="${disease.medicines}" var="d">
							<tr ><td align="left" height="22px"><a href="###">${d }</a></td></tr>
						</c:forEach>
					</c:otherwise>
					</c:choose>
						</table>
					...
					<c:otherwise>
						<c:forEach  items="${disease.semiotics }" var="a">
							<tr ><td align="left" height="22px"><a href="###">${a }</a></td></tr>
						</c:forEach>
						</c:otherwise>
						</c:choose>
						</table>
					...
					<c:otherwise>
						<c:forEach items="${disease.operations}" var="opera">
							<tr ><td align="left" height="22px"><a href="###">${opera}</a></td></tr>
						</c:forEach>
						</c:otherwise>
						</c:choose>
						</table>
					...
					<c:otherwise>
						<c:forEach  items="${disease.examines}" var="exa">
							<tr ><td align="left" height="22px"><a href="###">${exa }</a></td></tr>
						</c:forEach>
						</c:otherwise>
						</c:choose>
						</table>
					...
					<c:otherwise>
						<c:forEach  items="${disease.relateds}" var="rela">
							<tr ><td align="left" height="22px"><a href="###">${rela}</a></td></tr>
						</c:forEach>
						</c:otherwise>
						</c:choose>
						</table>
