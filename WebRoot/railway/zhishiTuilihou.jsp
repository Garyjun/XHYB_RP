...
<script type="text/javascript">
		...
		function goto1(uuid){
			$("#work_main").attr('src',"${path}/railway/chaxunzhishi.action?medicineId="+uuid);
		}
...
<div class="by-main-page-body-side" id="byMainPageBodySide" style="height: 100%;background-color:#e5e5e5;">
	...
	<div class="by-main-page-body-center" id="byMainPageBodyCenter">
	    <iframe id="work_main" name="work_main" width="100%" height="100%" frameborder="0" src="tuilihouMain.jsp"></iframe>
	</div>
