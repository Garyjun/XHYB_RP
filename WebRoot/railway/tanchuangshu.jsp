...
// 		});
	...
	function zTreeOnClick(event, treeId, treeNode) {
	    var url = '${path}/railway/tanxiangxi.jsp';
		//var xpath = treeNode.xpath+","+treeNode.code;
...
<body>
			<div style="overflow-y:auto; overflow-x:auto;float: left;width:250px; height:88%;margin-left: 10%">
				<ul id="tree" class="ztree form-wrap"></ul>
			</div>
			<div id="byMainPageBodyCenter" style="height: 602px;width:500px;float: left">
	    		<iframe id="work_main" name="work_main" width="100%" height="100%" frameborder="0" src="tanxiangxi.jsp"></iframe>
			</div>
			<input type="hidden" id="wordTypes" value="${param.type}"/>
			<input type="hidden" id="wordSize" value="${param.size}"/>
	<div style="text-align: center;"><input type="button" value="确定" onclick="queding();"/></div>
