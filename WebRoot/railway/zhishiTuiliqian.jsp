...
<script type="text/javascript">
		...
		function goto1(uuid){
			$("#work_main").attr('src',"${path}/railway/tuiliqianxiangxi.action?medicineId="+uuid);
		}
...
<div class="by-main-page-body-side" id="byMainPageBodySide" style="height: 100%;background-color:#e5e5e5;">
		...
		<div class="form-group">
		 <form action="" id="form" role="form" style="height: 100%;">
				<div id="sideWrap">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;<input id="name" type="text" name="name"/><a href="###" class="btn btn-default red" >搜索</a>
				<table width="90%" border="0" cellpadding="5" cellspacing="0">
				<c:forEach items="${gnc }" var="gnc">
			    <tr align="center" style="height: 30px;">
			    	<td>
			    	<a href="###" onclick="goto1('${gnc.uuid}')"><font size="3">${gnc.name}</font></a>
	...
	<div class="by-main-page-body-center" id="byMainPageBodyCenter">
	    <iframe id="work_main" name="work_main" width="100%" height="100%" frameborder="0" src="tuiliqianMain.jsp"></iframe>
	</div>
