...
<head>
	...
	function toSubmit(){
		var url = "${path}/article/toUpdate.action?objectId="+$('#objectId').val();
		alert(url);
		$('#coreData').ajaxSubmit({
			url: url,//表单的action
			type: 'post',//方式
...
<form action="#" id="coreData" class="form-horizontal">
	<app:ArticleMetadataEditTag   object="${scoEntity}" publishType="${publishType}"/>
	<input type="hidden" id="objectId" name="objectId" value="${objectId}"/>
	
	<div class="form-actions" align="center">
		<button type="button" class="btn btn-lg blue" onclick="toSubmit();">提交</button>
