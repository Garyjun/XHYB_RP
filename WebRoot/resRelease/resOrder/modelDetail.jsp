...
<body>
	<div id="fakeFrame" class="container-fluid by-frame-wrap" style="height: 100%;">
		<ul class="page-breadcrumb breadcrumb">
				<li><a href="javascript:;">发布模板详细</a></li>
		</ul>
                	...
                	<div class="form-group">
                     ...
                     <div class="form-group">
	                    <div class="row">
							...
							<%-- <c:if test="${paramsTempEntity.publishType=='onLine'}">
	                    	<label class="col-xs-1 control-label text-right">url：</label>
	                        <div class="col-xs-4">
	                    		<p class="control-label col-md-4">${paramsTempEntity.url}</p>
					 	 	</div> 
					 	 	</c:if> --%>
				 	 	</div>
 					 </div>
                     ...
                     <div class="form-group">
	                    <div class="row">
							<label class="col-xs-1 control-label text-right">发布内容：</label>
							<div class="col-xs-2 radio-list">
								<p class="control-label col-md-4">${paramsTempEntity.metaInfo}</p>
							</div>							                   
	                     </div>
                     </div>
...
<!-- 						</div>  -->
			...
			<div class="form-group">
				<div class="col-xs-offset-5 col-xs-7">
		            <input class="btn btn-primary" type="button" value="关闭" onclick="returnList();"/>
		        </div>
			</div>
		</div>      
</body>
