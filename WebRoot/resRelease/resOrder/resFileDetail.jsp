...
<script type="text/javascript">
	...
	function showTab() {
		...
		//定义一datagrid
		var _divId = 'data_div';
		var _url = '${path}/resOrder/resourceDetail.action?orderId=' + orderId + "&resId=" + resId +"&posttype="+posttype;
		var _pk = 'id';
		var _conditions = [];
...
<!-- 	</div> -->
	...
	<input id="restype" type="hidden" value="<%=request.getParameter("restype")%>"/>
	<input id="posttype" type="hidden" value="<%=request.getParameter("posttype")%>"/>
</body>
</html>