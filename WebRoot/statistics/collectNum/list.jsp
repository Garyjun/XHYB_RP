...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
	   		dt.setPK('objectId');
	   		dt.setConditions(['source','type','libType','module','status','operate']);
	   		dt.setSortName('id');
			...
			dt.setColums([ 
				...
				{field:'module',title:'模块名称',width:fillsize(0.1),sortable:true},
				{field:'type',title:'资源类型',width:fillsize(0.12),sortable:true},
				{field:'libType',title:'资源成熟度',width:fillsize(0.12),sortable:true},
		...
		function exportRes() {
	        ...
	        location.href='${path}/statistics/collectNum/exportRes.action?ids='+codes;
			}
		}
	...
	<div id="fakeFrame" class="container-fluid by-frame-wrap " style="height: 100%;">
		<div class="panel panel-default" style="height: 100%;">
			<div class="panel-heading" id="div_head_t">
				<ol class="breadcrumb">
					<li><a href="javascript:;">资源采集情况统计</a>
					</li>
				</ol>
			</div>
