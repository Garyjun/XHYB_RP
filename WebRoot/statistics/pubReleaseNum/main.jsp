...
<head>
	...
	<script type="text/javascript">
		...
		function formClear() {
			$('#publishType').val('');
			$('#channelName').val('');
			$('#filingDate_StartTime').val('');
			$('#filingDate_EndTime').val('');
		}
	</script>
</head>
                           ...
                           <div class="tab-pane active" id="tab_1_1_1">
							<form id="queryForm" action="" target="work_main" method="post">
                               ...
                               <div class="by-form-row clearfix">
                                   ...
                                   <div class="by-form-val">
                                       <input class="form-control Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'filingDate_EndTime\')}'})" id="filingDate_StartTime" name="filingDate_StartTime"/>
                                   </div>
                               </div>
                               <div class="by-form-row clearfix">
                                   <div class="by-form-title"><label for="filingDateEndTime">结束时间：</label></div>
                                   <div class="by-form-val">
                                       <input class="form-control Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'filingDate_StartTime\')}'})" id="filingDate_EndTime" name="filingDate_EndTime"/>
                                   </div>
                               </div>
