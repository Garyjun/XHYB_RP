...
<head>
	...
	<script type="text/javascript">
		...
		/* function queryForm(){
			var url = 'list.jsp?taskName='+$("#taskName").val()+"&processStatus="+$("#processStatus").val()+"&processName="+$("#processName").val()
					+"&startTime="+$("#startTime").val()+"&endTime="+$("#endTime").val();
			$('#work_main').attr('src',url);
		} */
		function queryForm(){
			var taskName = encodeURI(encodeURI($('#taskName').val()));
			var url = 'list.jsp?taskName='+taskName+"&startTime="+$("#startTime").val()+"&endTime="+$("#endTime").val();
			$('#work_main').attr('src',url);
		}
	</script>
</head>
                           ...
                           <div class="tab-pane active" id="tab_1_1_1">
							<form id="queryForm" action="" target="work_main" method="post">
							   <div class="by-form-row clearfix">
								...
								<%-- <div class="by-form-row clearfix">
								    <div class="by-form-title"><label for="abc">加工状态：</label></div>
								    <div class="by-form-val">
								    	<app:constants name="processStatus" id="processStatus" repository="com.brainsoon.system.support.SystemConstants" className="ProcessStatus" inputType="select" headerValue="全部" cssType="form-control"></app:constants>
								    </div>
								</div>
								<div class="by-form-row clearfix">
