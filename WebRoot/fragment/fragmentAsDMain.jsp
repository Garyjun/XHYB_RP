...
<script type="text/javascript">
		...
		$(document.ready).ready(function(){
			$.ajax({
				url:"${path}/system/FLTX/listContent.action?type=5&path=0",
				success:function(data){
					...
					$('#work_main1').attr('src','${path}/fragment/fragmentAsDList.jsp');
				}
			});	
		});
...
// 		    alert(treeNode.tId + ", " + treeNode.name);
		    var treeName = encodeURI(encodeURI(treeNode.name));
		    var url = '${path}/fragment/fragmentAsDList.jsp?treeName='+treeName;
