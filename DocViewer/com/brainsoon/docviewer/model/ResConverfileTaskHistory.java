...
/**
 *
 * @ClassName: ResConverfileTaskHistory
 * @Description:
 * 建表SQL:

CREATE TABLE `res_converfile_task_history` (
 ...
 */
@Entity
@Table(name = "res_converfile_task_history")
public class ResConverfileTaskHistory extends BaseHibernateObject  implements Comparable{

	    // Fields
		private static final long serialVersionUID = -1099178424494021196L;
		@Id
		...
		/** default constructor */
		public ResConverfileTaskHistory() {}



		public ResConverfileTaskHistory(String srcPath) {
			super();
			this.srcPath = srcPath;
		}

		public ResConverfileTaskHistory(String resId,String srcPath,String doHasType) {
			super();
			this.resId = resId;
			this.srcPath = srcPath;
		...
		public ResConverfileTaskHistory(String srcPath, String tarPath) {
			super();
			this.srcPath = srcPath;
		...
		public ResConverfileTaskHistory(String fileId, String resId, String fileType,
		...
		public ResConverfileTaskHistory(Long id, String fileId, Integer status,
				...
				Integer imgDoStauts, Integer txtDoStauts, Integer platformId,
