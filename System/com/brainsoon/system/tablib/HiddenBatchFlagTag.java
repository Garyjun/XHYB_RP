...
public class HiddenBatchFlagTag extends RequestContextAwareTag {
	...
	protected int doStartTagInternal() throws Exception {
		...
		for(MetadataDefinition metadataDefinition:metadataDefinitions){
			...
			sb.append("<input type=\"hidden\" id=\"").append(fieldName).append("\" name=\"").append(fieldName).append("\" qMatch=\"=\" />");
		}
