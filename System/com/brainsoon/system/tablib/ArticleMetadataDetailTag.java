...
public class ArticleMetadataDetailTag extends RequestContextAwareTag{
	...
	public StringBuffer getHtml(StringBuffer sb,MetadataDefinition metadataDefinition,String basePath){
		...
		if(StringUtils.isNotBlank(viewPriority) && viewPriority.contains("3")){
			...
			if(metadataDefinition.getFieldName().equals("numOfYear")){
			...
			if(!metadataDefinition.getFieldName().equals("sourceType")){
				switch(fieldType){
			    case 1:
			    	sb = ArticleMetadataUtil.createInput(sb,"", metadataDefinition,object,false);
			    	logger.info("input------------------------");
			    	break;
			    case 2:	
			    	sb = ArticleMetadataUtil.createSelect(sb,"", metadataDefinition,object,false,false);
			    	logger.info("select------------------------");
			    	break;
			    case 3:
			    	sb = ArticleMetadataUtil.createMoreSelect(sb,"", metadataDefinition,object,false,"");
//			    	sb = MetadataUtil.createCheckbox(sb,"",metadataDefinition,object,true);
			    	logger.info("checkbox------------------------");
			    	break;
			    case 4:	
			    	sb = ArticleMetadataUtil.createMoreSelect(sb,"", metadataDefinition,object,false,"onlySelect");
//			    	sb = MetadataUtil.createRadio(sb,"", metadataDefinition,object,true);
			    	logger.info("createRadio------------------------");
			    	break;
			    case 5:	
			    	sb = ArticleMetadataUtil.createTextarea(sb,"", metadataDefinition,object,false);
			    	logger.info("createTextarea------------------------");
			    	break;
			    case 6:	
			    	sb = ArticleMetadataUtil.createLookup(sb,"", metadataDefinition,object,false,basePath);
			    	logger.info("createLookup------------------------");
			    	break;
			    case 7:	
			    	sb = ArticleMetadataUtil.createDateTime(sb,"", metadataDefinition,object,false,"yyyy-MM-dd");
			    	logger.info("createDateTime----------------------");
			    	break;
			    case 8:	
			    	sb = ArticleMetadataUtil.createURL(sb,"", metadataDefinition,object,false);
			    	logger.info("createURL------------------------");
			    	break;
			    case 9:
			    //	sb = MetadataUtil.createSelect(sb, metadataDefinition,object,true,false);
			    	sb = ArticleMetadataUtil.createMultiSelect(sb, metadataDefinition, object, false, false);
			    	break;
			    case 10:
			    	sb = ArticleMetadataUtil.createLookupPeopleCompany(sb,"", metadataDefinition,object,false,basePath,"");
//			    	sb = MetadataUtil.createMoreSelect(sb,"", metadataDefinition,object,true,"");
			    	logger.info("createURL------------------------");
			    	break;
			    case 11:
			    	sb = ArticleMetadataUtil.createLookupPeopleCompany(sb,"", metadataDefinition,object,false,basePath,"company");
