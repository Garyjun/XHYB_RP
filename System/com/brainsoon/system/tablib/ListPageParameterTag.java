...
public class ListPageParameterTag extends RequestContextAwareTag {
...
//				}else{
					if(metadataDefinition.getQueryModel()==2||metadataDefinition.getQueryModel()==3){
						sb.append("'&").append(metadataDefinition.getFieldName()+"_metaField").append("='+$('#").append(metadataDefinition.getFieldName()+"_metaField").append("').val()+");
