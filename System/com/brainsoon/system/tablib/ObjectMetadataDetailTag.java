...
public class ObjectMetadataDetailTag extends RequestContextAwareTag {
	...
	public StringBuffer getHtml(StringBuffer sb,MetadataDefinition metadataDefinition,String basePath){
		...
		if(StringUtils.isNotBlank(viewPriority) && viewPriority.contains("3")){
			...
			if(!metadataDefinition.getFieldName().equals("sourceType")){
				switch(fieldType){
			    case 1:
			    	sb = MetadataUtil.createInput(sb,"", metadataDefinition,object,false);
			    	logger.info("input------------------------");
			    	break;
			    case 2:	
			    	...
			    	break;
			    case 3:
			    	sb = MetadataUtil.createMoreSelect(sb,"", metadataDefinition,object,false,"");
//			    	sb = MetadataUtil.createCheckbox(sb,"",metadataDefinition,object,true);
			    	logger.info("checkbox------------------------");
			    	break;
			    case 4:	
			    	sb = MetadataUtil.createMoreSelect(sb,"", metadataDefinition,object,false,"onlySelect");
//			    	sb = MetadataUtil.createRadio(sb,"", metadataDefinition,object,true);
			    ...
			    case 5:	
			    	...
			    	break;
			    case 6:	
			    	sb = MetadataUtil.createLookup(sb,"", metadataDefinition,object,false,basePath);
			    	logger.info("createLookup------------------------");
			    	break;
			    case 7:	
			    	sb = MetadataUtil.createDateTime(sb,"", metadataDefinition,object,false,"yyyy-MM-dd");
			    	logger.info("createDateTime----------------------");
			    	break;
			    case 8:	
			    	sb = MetadataUtil.createURL(sb,"", metadataDefinition,object,false);
			    	logger.info("createURL------------------------");
			    	break;
			    case 9:
			    //	sb = MetadataUtil.createSelect(sb, metadataDefinition,object,true,false);
			    	sb = MetadataUtil.createMultiSelect(sb, metadataDefinition, object, false, false);
			    	break;
			    case 10:
			    	sb = MetadataUtil.createLookupPeopleCompany(sb,"", metadataDefinition,object,false,basePath,"");
//			    	sb = MetadataUtil.createMoreSelect(sb,"", metadataDefinition,object,true,"");
			    	logger.info("createURL------------------------");
			    	break;
			    case 11:
			    	sb = MetadataUtil.createLookupPeopleCompany(sb,"", metadataDefinition,object,false,basePath,"company");
