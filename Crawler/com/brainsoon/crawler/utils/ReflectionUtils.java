...
public class ReflectionUtils {
		...
		if (object != null) {
			...
			for (Field field : fields) {
				...
				if (field.getGenericType().toString().equals("class java.lang.Boolean")) {
					m = (Method) object.getClass().getMethod(field.getName());
				}
				// boolean
	...
	public static void setObjectValue(Object object) throws Exception {
		if (object != null) {
			Class<?> clzz = object.getClass();
			Field[] fields = clzz.getDeclaredFields();
			for (Field field : fields) {
				...
				// String
				if (field.getGenericType().toString().equals("class java.lang.String")) {
					m = (Method) object.getClass().getMethod("set" + getMethodName(field.getName()));
				}
				// Integer
				if (field.getGenericType().toString().equals("class java.lang.Integer")) {
					m = (Method) object.getClass().getMethod("set" + getMethodName(field.getName()));
